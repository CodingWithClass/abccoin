...
// Copyright (c) 2013 ClassCoin developers
...
const string strMessageMagic = "ClassCoin Signed Message:\n";
...
static const int64 nStartSubsidy = 8192 * COIN;
...
static const int64 nTargetTimespan = 20; // 1 minutes
static const int64 nTargetSpacing = 10; // 30 seconds
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("ClassCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("ClassCoinMiner : ProcessBlock, block not accepted");
    }
...
void static BitcoinMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        printf("Running ClassCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("ClassCoinMiner terminated\n");
        throw;
    }
}
